...
class AroonIndicator(IndicatorMixin):
    ...
    def aroon_up(self) -> pd.Series:
        ...
        return pd.Series(aroon_up_series, name="aroon_up_{0}".format(self._window))
    ...
    def aroon_down(self) -> pd.Series:
        ...
        return pd.Series(aroon_down_series, name="aroon_down_{0}".format(self._window))
    ...
    def aroon_indicator(self) -> pd.Series:
        ...
        return pd.Series(aroon_diff, name="aroon_ind_{0}".format(self._window))
...
class MACD(IndicatorMixin):
    ...
    def macd(self) -> pd.Series:
        ...
        return pd.Series(
            macd_series, name="MACD_{0}_{1}".format(self._window_fast,self._window_slow)
        )
    ...
    def macd_signal(self) -> pd.Series:
        ...
        return pd.Series(
            macd_signal_series,
            name="MACD_sign_{0}_{1}".format(self._window_fast,self._window_slow),
        )
    ...
    def macd_diff(self) -> pd.Series:
        ...
        return pd.Series(
            macd_diff_series, name="MACD_diff_{0}_{1}".format(self._window_fast,self._window_slow)
        )
...
class EMAIndicator(IndicatorMixin):
    ...
    def ema_indicator(self) -> pd.Series:
        ...
        return pd.Series(ema_, name="ema_{0}".format(self._window))
...
class SMAIndicator(IndicatorMixin):
    ...
    def sma_indicator(self) -> pd.Series:
        ...
        return pd.Series(sma_, name="sma_{0}".format(self._window))
...
class WMAIndicator(IndicatorMixin):
    ...
    def wma(self) -> pd.Series:
        ...
        return pd.Series(wma, name="wma_{0}".format(self._window))
...
class TRIXIndicator(IndicatorMixin):
    ...
    def trix(self) -> pd.Series:
        ...
        return pd.Series(trix_series, name="trix_{0}".format(self._window))
...
class MassIndex(IndicatorMixin):
    ...
    def mass_index(self) -> pd.Series:
        ...
        return pd.Series(
            mass, name="mass_index_{0}_{1}".format(self._window_fast,self._window_slow)
        )
...
class IchimokuIndicator(IndicatorMixin):
    ...
    def ichimoku_conversion_line(self) -> pd.Series:
        ...
        return pd.Series(
            conversion, name="ichimoku_conv_{self._window1}_{self._window2}"
        )
    ...
    def ichimoku_base_line(self) -> pd.Series:
        ...
        return pd.Series(base, name="ichimoku_base_{0}_{1}".format(self._window1,self._window2))
    ...
    def ichimoku_a(self) -> pd.Series:
        ...
        return pd.Series(spana, name="ichimoku_a_{0}_{1}".format(self._window1,self._window2))
    ...
    def ichimoku_b(self) -> pd.Series:
        ...
        return pd.Series(spanb, name="ichimoku_b_{0}_{1}".format(self._window1,self._window2))
