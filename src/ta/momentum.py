...
class PercentagePriceOscillator(IndicatorMixin):
    ...
    def ppo(self):
        ...
        return pd.Series(
            ppo_series, name="PPO_{0}_{1}".format(self._window_fast,self._window_slow)
        )
    ...
    def ppo_signal(self):
        ...
        return pd.Series(
            ppo_signal_series, name="PPO_sign_{0}_{1}".format(self._window_fast,self._window_slow)
        )
    ...
    def ppo_hist(self):
        ...
        return pd.Series(
            ppo_hist_series, name="PPO_hist_{0}_{1}".format(self._window_fast,self._window_slow)
        )
...
class PercentageVolumeOscillator(IndicatorMixin):
    ...
    def pvo(self) -> pd.Series:
        ...
        return pd.Series(
            pvo_series, name="PVO_{0}_{1}".format(self._window_fast,self._window_slow)
        )
    ...
    def pvo_signal(self) -> pd.Series:
        ...
        return pd.Series(
            pvo_signal_series, name="PVO_sign_{0}_{1}".format(self._window_fast,self._window_slow)
        )
    ...
    def pvo_hist(self) -> pd.Series:
        ...
        return pd.Series(
            pvo_hist_series, name="PVO_hist_{0}_{1}".format(self._window_fast,self._window_slow)
        )
